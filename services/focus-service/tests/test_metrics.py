...
class MetricsTests(unittest.TestCase):
    ...
    def test_request_metrics_use_templated_routes(self) -> None:
        status, _, _ = asyncio.run(request("/sessions/00000000-0000-0000-0000-000000000000/start"))
        self.assertEqual(status, 405)
        _, body, _ = asyncio.run(request("/metrics"))
        self.assertIn(b'route="/sessions/{session_id}/start"', body)
        self.assertNotIn(b"00000000-0000-0000-0000-000000000000", body)
